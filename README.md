...
A Python script that deduplicates a product list using AI to assign a canonical name to each product. Products that refer to the same item are merged, keeping only the lowest-priced entry.
